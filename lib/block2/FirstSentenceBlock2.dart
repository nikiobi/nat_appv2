...
import 'package:nat_appv2/block2/SecondSentenceBlock2.dart';
import 'package:nat_appv2/GlobalResultLists.dart';

class FirstSentenceBlock2 extends StatefulWidget {
  const FirstSentenceBlock2({super.key});

  @override
  State<FirstSentenceBlock2> createState() => _FirstSentenceBlock2State();
}

class _FirstSentenceBlock2State extends State<FirstSentenceBlock2> {
  ...
  SizedBox spaceBetweenBoxestopHeight2 = const SizedBox(height: 5);
  ...
  final fix2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz1/Frausquared.png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz1/Mann.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz1/Mannsquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz1/Manntragged.png'),
    ),
  );
  ...
  final word4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz1/gekuesst.png'),
    ),
  );
  ...
  final word4squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz1/gekuesstsquared.png'),
    ),
  );
  ...
  final word4tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz1/gekuessttragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block2 - Satz1', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
      ...
      case 5:
        switch (data) {
          ...
          case 'tickling3':
            ...
            resultb2s1[5] = true;
            placedwordb2s1[5] = 'geküsst';
            worddroppedorder.add('geküsst');
            break;
          case 'tickling4':
            imagetoimage51 = word2;
            imagetoimage52 = word2squared;
            resultb2s1[5] = false;
            placedwordb2s1[5] = 'vom';
  ...
  void _DetermineOrder() {
    setState((){
      switch (placedwordb2s1[2]) {
        ...
        case 'geküsst':
          for (int i=0; i < 4; i++){
            if (worddroppedorder[i] == 'geküsst') {
              wordorderb2s1[2] = i+1;
            }
          }
          break;
      }
      switch (placedwordb2s1[3]) {
        case 'wird':
          for (int i=0; i < 4; i++){
            if (worddroppedorder[i] == 'wird') {
              wordorderb2s1[3] = i+1;
