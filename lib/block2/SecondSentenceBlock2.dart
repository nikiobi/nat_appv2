...
import 'package:nat_appv2/block2/ThirdSentenceBlock2.dart';
import 'package:nat_appv2/GlobalVariables.dart';

class SecondSentenceBlock2 extends StatefulWidget {
  const SecondSentenceBlock2({super.key});

  @override
  State<SecondSentenceBlock2> createState() => _SecondSentenceBlock2State();
}

class _SecondSentenceBlock2State extends State<SecondSentenceBlock2> {
  ...
  SizedBox spaceBetweenBoxestopHeight2 = const SizedBox(height: 30);
  ...
  final fix2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/Mannsquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/Rettet.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/Rettetsquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/rettetragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/die.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/diesquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/dietragged .png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/Frau.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/Frausquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz2/Frautragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block2 - Satz2', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
