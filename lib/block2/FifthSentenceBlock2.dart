...
import 'package:nat_appv2/block2/SixthSentenceBlock2.dart';
import 'package:nat_appv2/GlobalVariables.dart';

class FifthSentenceBlock2 extends StatefulWidget {
  const FifthSentenceBlock2({super.key});

  @override
  State<FifthSentenceBlock2> createState() => _FifthSentenceBlock2State();
}

class _FifthSentenceBlock2State extends State<FifthSentenceBlock2> {
  ...
  SizedBox spaceBetweenBoxestopWidth3 = const SizedBox(width: 100);
  SizedBox spaceBetweenBoxestopHeight1 = const SizedBox(height: 20);
  SizedBox spaceBetweenBoxestopHeight2 = const SizedBox(height: 26);
  SizedBox spaceBetweenBoxestopHeight3 = SizedBox(height: 1);
  ...
  final fix3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/densquared.png'),
    ),
  );
  ...
  final fix4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/Jungensquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/der.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/dersquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/dertragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/das.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/dassquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/dastragged.png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/maedchen.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/maedchensquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/maedchentragged.png'),
    ),
  );
  ...
  final word4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/zieht .png'),
    ),
  );
  ...
  final word4squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/ziehtsquared.png'),
    ),
  );
  ...
  final word4tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block2/Satz5/ziehttragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block2 - Satz5', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
