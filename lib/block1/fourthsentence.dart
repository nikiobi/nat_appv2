...
import 'package:nat_appv2/block1/fifthsentence.dart';
import 'package:nat_appv2/GlobalVariables.dart';

class FourthSentenceBlock1 extends StatefulWidget {
  const FourthSentenceBlock1({super.key});

  @override
  State<FourthSentenceBlock1> createState() => _FourthSentenceBlock1State();
}

class _FourthSentenceBlock1State extends State<FourthSentenceBlock1> {
  ...
  SizedBox spaceBetweenBoxestopHeight1 = const SizedBox(height: 90);
  SizedBox spaceBetweenBoxestopHeight2 = const SizedBox(height: 100);
  SizedBox spaceBetweenBoxestopHeight3 = SizedBox(height: 20);
  ...
  final fix1 = SizedBox(
    ...
    width: 200,
    child: Center(
      child: Image.asset('images/Block1/Satz4/wer.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block1/Satz4/jagt.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block1/Satz4/jagtsquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block1/Satz4/jagttragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block1/Satz4/die.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block1/Satz4/diesquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block1/Satz4/dietragged .png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block1/Satz4/Katze.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block1/Satz4/Katzetragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block1 - Satz4', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
