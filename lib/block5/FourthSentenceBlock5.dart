...
import 'package:nat_appv2/block5/FifthSentenceBlock5.dart';
import 'package:nat_appv2/GlobalVariables.dart';

class FourthSentenceBlock5 extends StatefulWidget {
  const FourthSentenceBlock5({super.key});

  @override
  State<FourthSentenceBlock5> createState() => _FourthSentenceBlock5State();
}

class _FourthSentenceBlock5State extends State<FourthSentenceBlock5> {
  ...
  SizedBox spaceBetweenBoxestopHeight2 = const SizedBox(height: 10);
  ...
  final fix1 = SizedBox(
    ...
    width: 200,
    child: Center(
      child: Image.asset('images/Block5/Satz4/wer.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz4/kuesst.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz4/kuesstsquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz4/kuessttragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz4/die.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz4/diesquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz4/dietragged .png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz4/Frau.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz4/Frausquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz4/Frautragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block5 - Satz4', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
