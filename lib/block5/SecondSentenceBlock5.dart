...
import 'package:nat_appv2/block5/ThirdSentenceBlock5.dart';
import 'package:nat_appv2/GlobalResultLists.dart';

class SecondSentenceBlock5 extends StatefulWidget {
  const SecondSentenceBlock5({super.key});

  @override
  State<SecondSentenceBlock5> createState() => _SecondSentenceBlock5State();
}

class _SecondSentenceBlock5State extends State<SecondSentenceBlock5> {
  ...
  final fix1 = SizedBox(
    ...
    width: 200,
    child: Center(
      child: Image.asset('images/Block5/Satz2/Wensquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz2/kuesst.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz2/kuesstsquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz2/kuessttragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz2/der.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz2/dersquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz2/dertragged.png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz2/Mann.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz2/Mannsquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz2/Manntragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block5 - Satz2', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
