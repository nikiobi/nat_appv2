...
import 'package:nat_appv2/block5/SixthSentenceBlock5.dart';
import 'package:nat_appv2/GlobalResultLists.dart';

class FifthSentenceBlock5 extends StatefulWidget {
  const FifthSentenceBlock5({super.key});

  @override
  State<FifthSentenceBlock5> createState() => _FifthSentenceBlock5State();
}

class _FifthSentenceBlock5State extends State<FifthSentenceBlock5> {
  ...
  SizedBox spaceBetweenBoxestopHeight3 = SizedBox(height: 40);
  ...
  final fix3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/densquared.png'),
    ),
  );
  ...
  final fix4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/Mannsquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/der.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/dersquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/dertragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/die.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/diesquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/dietragged .png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/Frau.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/Frausquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/Frautragged.png'),
    ),
  );
  ...
  final word4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/kuesst.png'),
    ),
  );
  ...
  final word4squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/kuesstsquared.png'),
    ),
  );
  ...
  final word4tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz5/kuessttragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block5 - Satz5', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
