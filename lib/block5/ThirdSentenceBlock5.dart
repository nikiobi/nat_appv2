...
import 'package:nat_appv2/block5/FourthSentenceBlock5.dart';
import 'package:nat_appv2/GlobalVariables.dart';

class ThirdSentenceBlock5 extends StatefulWidget {
  const ThirdSentenceBlock5({super.key});

  @override
  State<ThirdSentenceBlock5> createState() => _ThirdSentenceBlock5State();
}

class _ThirdSentenceBlock5State extends State<ThirdSentenceBlock5> {
  ...
  SizedBox spaceBetweenBoxestopWidth2 = const SizedBox(width: 200);
  SizedBox spaceBetweenBoxestopWidth3 = const SizedBox(width: 700);
  ...
  final fix4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/Frausquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/die.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/diesquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/dietragged .png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/der.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/dersquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/dertragged.png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/Mann.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/Mannsquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/Manntragged.png'),
    ),
  );
  ...
  final word4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/Rettet.png'),
    ),
  );
  ...
  final word4squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/Rettetsquared.png'),
    ),
  );
  ...
  final word4tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz3/rettetragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block5 - Satz3', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
