...
class SixthSentenceBlock5 extends StatefulWidget {
  ...
  @override
  State<SixthSentenceBlock5> createState() => _SixthSentenceBlock5State();
}

class _SixthSentenceBlock5State extends State<SixthSentenceBlock5> {
  ...
  final fix2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz6/Frausquared.png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz6/Mann.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz6/Mannsquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz6/Manntragged.png'),
    ),
  );
  ...
  final word4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz6/Gerettet.png'),
    ),
  );
  ...
  final word4squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz6/Gerettetsquared.png'),
    ),
  );
  ...
  final word4tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block5/Satz6/Gerettettragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block5 - Satz6', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
      ...
      case 5:
        switch (data) {
          ...
          case 'tickling3':
            ...
            resultb5s6[5] = true;
            placedwordb5s6[5] = 'gerettet';
            worddroppedorder.add('gerettet');
            break;
          case 'tickling4':
            imagetoimage51 = word2;
            imagetoimage52 = word2squared;
            resultb5s6[5] = false;
            placedwordb5s6[5] = 'vom';
  ...
  void _DetermineOrder() {
    setState((){
      switch (placedwordb5s6[2]) {
        ...
        case 'gerettet':
          for (int i=0; i < 4; i++){
            if (worddroppedorder[i] == 'gerettet') {
              wordorderb5s6[2] = i+1;
            }
          }
          break;
      }
      switch (placedwordb5s6[3]) {
        case 'wird':
          for (int i=0; i < 4; i++){
            if (worddroppedorder[i] == 'wird') {
              wordorderb5s6[3] = i+1;
