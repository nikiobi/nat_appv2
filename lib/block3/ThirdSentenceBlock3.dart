...
import 'package:nat_appv2/block3/FourthSentenceBlock3.dart';
import 'package:nat_appv2/GlobalVariables.dart';

class ThirdSentenceBlock3 extends StatefulWidget {
  const ThirdSentenceBlock3({super.key});

  @override
  State<ThirdSentenceBlock3> createState() => _ThirdSentenceBlock3State();
}

class _ThirdSentenceBlock3State extends State<ThirdSentenceBlock3> {
  ...
  SizedBox spaceBetweenBoxestopHeight2 = const SizedBox(height:90);
  SizedBox spaceBetweenBoxestopHeight3 = SizedBox(height: 60);
  SizedBox spaceBetweenBoxestopHeight4 = SizedBox(height: 0);
  ...
  final fix3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/dassquared.png'),
    ),
  );
  ...
  final fix4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/maedchensquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/das.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/dastragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/der.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/dersquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/dertragged.png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/Junge.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/jungesquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/Jungetragged .png'),
    ),
  );
  ...
  final word4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/schubst.png'),
    ),
  );
  ...
  final word4squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/schubstsquared.png'),
    ),
  );
  ...
  final word4tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz3/schubsttragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block3 - Satz3', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
