...
import 'package:nat_appv2/block3/SecondSentenceBlock3.dart';
import 'package:nat_appv2/GlobalVariables.dart';

class FirstSentenceBlock3 extends StatefulWidget {
  const FirstSentenceBlock3({super.key});

  @override
  State<FirstSentenceBlock3> createState() => _FirstSentenceBlock3State();
}

class _FirstSentenceBlock3State extends State<FirstSentenceBlock3> {
  ...
  SizedBox spaceBetweenBoxestopHeight1 = const SizedBox(height: 7);
  SizedBox spaceBetweenBoxestopHeight2 = const SizedBox(height: 60);
  SizedBox spaceBetweenBoxestopHeight3 = SizedBox(height: 21);
  ...
  final fix1 = SizedBox(
    ...
    width: 200,
    child: Center(
      child: Image.asset('images/Block2/Satz2/dersquared.png'),
    ),
  );
  ...
  final fix2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/jungesquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/schubst.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/schubstsquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/schubsttragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/das.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/dassquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/dastragged.png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/maedchen.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/maedchensquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block3/Satz1/maedchentragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block3 - Satz1', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
