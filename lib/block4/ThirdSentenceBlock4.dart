...
import 'package:nat_appv2/block4/FourthSentenceBlock4.dart';
import 'package:nat_appv2/GlobalVariables.dart';

class ThirdSentenceBlock4 extends StatefulWidget {
  const ThirdSentenceBlock4({super.key});

  @override
  State<ThirdSentenceBlock4> createState() => _ThirdSentenceBlock4State();
}

class _ThirdSentenceBlock4State extends State<ThirdSentenceBlock4> {
  ...
  SizedBox spaceBetweenBoxestopWidth1 = const SizedBox(width: 300);
  ...
  SizedBox spaceBetweenBoxestopHeight4 = SizedBox(height: 80);
  ...
  final fix2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/sah.png'),
    ),
  );
  ...
  final fix3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/densquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/der.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/dersquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/dertragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/die.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/diesquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/dietragged .png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/Katze.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/Katzetragged.png'),
    ),
  );
  ...
  final word4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/jagt.png'),
    ),
  );
  ...
  final word4squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/Jagtsquared.png'),
    ),
  );
  ...
  final word4tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz3/Jagttragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block4 - Satz3', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
      ...
      case 5:
        switch (data) {
          ...
          case 'tickling2':
            ...
            resultb4s3[7] = false;
            placedwordb4s3[7] = 'Katze';
            worddroppedorder.add('Katze');
            break;
          case 'tickling3':
            imagetoimage51 = word4;
            imagetoimage52 = word4squared;
            resultb4s3[7] = true;
            placedwordb4s3[7] = 'jagt';
