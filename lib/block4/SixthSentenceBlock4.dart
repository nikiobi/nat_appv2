...
class SixSentenceBlock4 extends StatefulWidget {
  const SixSentenceBlock4({super.key});

  @override
  State<SixSentenceBlock4> createState() => _SixSentenceBlock4State();
}

class _SixSentenceBlock4State extends State<SixSentenceBlock4> {
  ...
  final fix1 = SizedBox(
    ...
    width: 200,
    child: Center(
      child: Image.asset('images/Block4/Satz6/wer.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz6/schubst.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz6/schubstsquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz6/schubsttragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz6/das.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz6/dassquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz6/dastragged.png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz6/maedchen.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz6/maedchensquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz6/maedchentragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block4 - Satz6', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
