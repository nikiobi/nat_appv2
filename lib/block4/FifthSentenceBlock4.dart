...
import 'package:nat_appv2/block4/SixthSentenceBlock4.dart';
import 'package:nat_appv2/GlobalVariables.dart';

class FifthSentenceBlock4 extends StatefulWidget {
  const FifthSentenceBlock4({super.key});

  @override
  State<FifthSentenceBlock4> createState() => _FifthSentenceBlock4State();
}

class _FifthSentenceBlock4State extends State<FifthSentenceBlock4> {
  ...
  final fix1 = SizedBox(
    ...
    width: 200,
    child: Center(
      child: Image.asset('images/Block4/Satz5/dersquared.png'),
    ),
  );
  ...
  final fix2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/Hundsquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/jagt.png'),
    ),
  );
  ...
  final word1squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/Jagtsquared.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/Jagttragged.png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/die.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/diesquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/dietragged .png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/Katze.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/Katzesquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz5/Katzetragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block4 - Satz5', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
            actions: [
              IconButton(
