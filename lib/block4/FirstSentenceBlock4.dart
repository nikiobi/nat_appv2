...
import 'package:nat_appv2/block4/SecondSentenceBlock4.dart';
import 'package:nat_appv2/GlobalResultLists.dart';

class FirstSentenceBlock4 extends StatefulWidget {
  const FirstSentenceBlock4({super.key});

  @override
  State<FirstSentenceBlock4> createState() => _FirstSentenceBlock4State();
}

class _FirstSentenceBlock4State extends State<FirstSentenceBlock4> {
  ...
  SizedBox spaceBetweenBoxestopHeight1 = const SizedBox(height: 80);
  SizedBox spaceBetweenBoxestopHeight2 = const SizedBox(height: 0);
  SizedBox spaceBetweenBoxestopHeight3 = SizedBox(height: 60);
  SizedBox spaceBetweenBoxestopHeight4 = SizedBox(height: 50);
  ...
  final fix3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/diesquared.png'),
    ),
  );
  ...
  final fix4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/Katzesquared.png'),
    ),
  );
  ...
  final word1 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/die.png'),
    ),
  );
  ...
  final word1tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/dietragged .png'),
    ),
  );
  ...
  final word2 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/der.png'),
    ),
  );
  ...
  final word2squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/dersquared.png'),
    ),
  );
  ...
  final word2tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/dertragged.png'),
    ),
  );
  ...
  final word3 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/Hund.png'),
    ),
  );
  ...
  final word3squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/Hundsquared.png'),
    ),
  );
  ...
  final word3tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/Hundtragged.png'),
    ),
  );
  ...
  final word4 = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/jagt.png'),
    ),
  );
  ...
  final word4squared = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/Jagtsquared.png'),
    ),
  );
  ...
  final word4tragged = SizedBox(
    ...
    width: 200.0,
    child: Center(
      child: Image.asset('images/Block4/Satz1/Jagttragged.png'),
    ),
  );
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: <Widget>[
          AppBar(
            title: const Text('Block4 - Satz1', textScaleFactor: 2),
            centerTitle: true,
            toolbarHeight: 100,
